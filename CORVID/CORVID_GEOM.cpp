...
/*
bool CORVID_RECT<int>::pointIsInside(int x_val, int y_val) {
	return false;
};
bool CORVID_RECT<int>::pointIsInside(double x_val, double y_val) {
	return false;
};
bool CORVID_RECT<int>::pointIsInside(CORVID_R2<int> point) {
	return false;
};
*/
